...
class ExceptionHandler(
    ...
    fun handleWarehouseAppException(ex: UserAppException): ResponseEntity<BaseMessage> {
...
sealed class UserAppException(message: String? = null) : RuntimeException() {
...
class EmailAlreadyExistsException() : UserAppException(){
